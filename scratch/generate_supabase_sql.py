...
with open("supabase/migrations/20260924_init_simponitas.sql", "w", encoding="utf-8") as f:
    f.write(sql_content)

print("SUCCESS: supabase/schema.sql and supabase/migrations/20260924_init_simponitas.sql generated!")
